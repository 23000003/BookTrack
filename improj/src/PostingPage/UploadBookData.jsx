...
export default function UploadData(){
    ...
    return(
        ...
        <div className="upload-container-content">
            <h2 className='upload-tagline'>WHAT BOOK ARE YOU SELLING?</h2>
            ...
            <div className="book-upload-data">
                <label htmlFor="Title-Input">Title *</label><input type="text" name="" id="Title-Input" maxLength="19"/>
                <label htmlFor="Price-Input">Price *</label><input type="text" name="" id="Price-Input"/>
                <label htmlFor="Location-Input">Location *</label>
                <select name="" id="Location-Input">
                ...
                <label htmlFor="Location-Tag">Paste Location from Google Map *</label><input type="text" name="" id="Location-Tag"/>
                ...
                <label htmlFor="Quantity-Input">Quantity *</label><input type="text" name="" id="Quantity-Input"/>
                <label htmlFor="Author-Input">Author *</label><input type="text" name="" id="Author-Input"/>
                <label htmlFor="Description-Input">Description *</label><textarea type="text" id="Description-Input" style={{height: "100px"}}></textarea>
            </div>
            <div className="check">
